				...
				<div class="modal-content">
					...
					<form role="form" data-toggle="validator" class="RegisterLogin" id="loginForm">
						...
						<div class="modal-footer  form-group">
							<button id="actionBtn" type="submit" class="btn theme-btn-2 cricle model" value="on">上課</button>
							<button id="actionBtn2" type="submit" class="btn theme-btn-2 cricle model" value="leave">下課</button>
