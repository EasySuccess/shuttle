...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "user/menu.php";
  $MM_redirectLoginFailed = "loginFailed.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_cardsystem, $cardsystem);
  	
  $LoginRS__query=sprintf("SELECT UserName, UserPw, UserRole FROM tbuser WHERE UserName=%s AND UserPw=%s",
  GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
   
  $LoginRS = mysql_query($LoginRS__query, $cardsystem) or die(mysql_error());
