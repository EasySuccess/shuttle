				...
				<form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="form-horizontal">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="textinput" name="StuName" type="text" value="<?php echo $RecordsetStd['StuName']; ?>" class="form-control input-md">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="textinput" name="StuBirth" type="text" value="<?php echo $RecordsetStd['StuBirth']; ?>" class="form-control input-md">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="textinput" name="StuAddress" type="text" value="<?php echo $RecordsetStd['StuAddress']; ?>" class="form-control input-md">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
							...
							<div class="col-md-2">
								<input id="textinput" name="StuFather" type="text" value="<?php echo $RecordsetStd['StuFather']; ?>" class="form-control input-md">
							</div>
							<div class="col-md-2">
								<input id="textinput" name="StuFatherTel" type="text"  placeholder="聯絡電話" value="<?php echo $RecordsetStd['StuFatherTel']; ?>" class="form-control input-md">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
							...
							<div class="col-md-2">
								<input id="textinput" name="StuMum" type="text" value="<?php echo $RecordsetStd['StuMum']; ?>" class="form-control input-md">
							</div>
							<div class="col-md-2">
								<input id="textinput" name="StuMumTel" type="text"  placeholder="聯絡電話" value="<?php echo $RecordsetStd['StuMumTel']; ?>" class="form-control input-md">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="textinput" name="StuRemark" type="text" value="<?php echo $RecordsetStd['StuRemark']; ?>" class="form-control input-md">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="textinput" name="StuGrad" type="text" value="<?php echo $RecordsetStd['StuGrad']; ?>" class="form-control input-md">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
