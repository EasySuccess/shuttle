<?php
	...
	$query_RecordsetStd  = sprintf("SELECT tbCard.StuCode, tbCard.CardId, tbCard.Created, tbCard.Modified, tbStudent.StuName FROM tbCard LEFT JOIN tbStudent ON tbCard.StuCode=tbStudent.StuCode WHERE tbCard.CoCode = %s", GetSQLValueString($colname_RecordsetStd, "int"));
