...
$result = DB::queryFirstRow("SELECT CoFullName FROM tbco WHERE CoCode = %d", $_SESSION['MM_CoCode']);
$_SESSION['MM_CoFullName'] = $result["CoFullName"];
         ...
         <div class="col-md-4">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  ...
                  <b>公司</b>:<?php echo $_SESSION['MM_CoFullName'] ;?><br>
               </div>
            </div>
         </div>
      </div>
