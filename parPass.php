...
<html>
	...
	<body>
		...
		<a href="#" data-toggle="modal" data-target="#checkInModal" id="checkInBtn" class="btn theme-btn-3">Touch it</a>
				...
				<div class="modal-content">
					...
					<form role="form" data-toggle="validator" class="RegisterLogin" id="loginForm">
						...
						<div class="modal-footer  form-group">
							<button id="pickWait" type="submit" class="btn theme-btn-2 cricle hide model" value="1">等一下</button>
							<button id="pickNow" type="submit" class="btn theme-btn-2 cricle hide model" value="99">立即接走</button>
							<button type="close" class="btn theme-btn-2 cricle model" data-dismiss="modal">返回</button>
						</div>
					</form>
				</div>
			</div>
