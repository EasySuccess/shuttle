...
if (isset($_GET['CoCode'])) {
	$recordSet = DB::queryFirstRow("SELECT * FROM $tableName WHERE CoCode = %s", $_GET['CoCode']);
}else{
	$recordSet = NULL;
}
				...
				<form method="post" name="form1" action="<?php echo $formAction; ?>" class="form-horizontal">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="textinput" name="CoCode" type="text" value="<?php echo $recordSet['CoCode']; ?>" class="form-control input-md" readonly>
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
							<label class="col-md-4 control-label" for="textinput">公司名稱:</label>  
							<div class="col-md-4">
								<input id="textinput" name="CoName" type="text" value="<?php echo $recordSet['CoName']; ?>" class="form-control input-md">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="textinput" name="CoAddress" type="text" value="<?php echo $recordSet['CoAddress']; ?>" class="form-control input-md">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="textinput" name="CoTel" type="text" value="<?php echo $recordSet['CoTel']; ?>" class="form-control input-md">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
							...
							<div class="col-md-2">
								<input id="textinput" name="CoContact" type="text" value="<?php echo $recordSet['CoContact']; ?>" class="form-control input-md">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
							...
							<div class="col-md-2">
								<input id="textinput" name="CoEmail" type="text" value="<?php echo $recordSet['CoEmail']; ?>" class="form-control input-md">
							</div>
						</div>
						<div class="form-group">
