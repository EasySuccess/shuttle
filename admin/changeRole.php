				...
				<form method="post" name="form1" action="<?php echo $formAction ?>" class="form-horizontal">
					<fieldset>
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="textinput">用戶權限:</label>  
							<div class="col-md-4">
								<select name="UserRole">
									<option value="admin">超級管理員</admin>
									<option value="company">公司管理員</admin>
									<option value="staff">公司員工</admin>
								</select>
							</div>
						</div>
						<div class="form-group">
